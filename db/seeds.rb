...
post = Post.create!(title: "Le Zero Trust, un modèle à explorer", content: "Zero Trust, ZTNA (Zero Trust Network Access) ou plus globalement SASE (Secure Access Service Edge), tous ces concepts ou modèles de...",url: "https://www.lemondeinformatique.fr/les-dossiers/sommaire-lire-le-zero-trust-un-modele-a-explorer-239.html",user_id: user1.id)
post.save

post = Post.create!(title: "Okta se fait hacker ses répertoires de code source GitHub", content: "Quelques mois après avoir été piraté par le cybergang Lapsus$, le spécialiste en solutions d'authentification et gestion des accès Okta annonce le hack de ses répertoires de code...",
url: "https://www.lemondeinformatique.fr/actualites/lire-okta-se-fait-hacker-ses-repertoires-de-code-source-github-88988.html",user_id: user1.id)
post.save
